...
tf.flags.DEFINE_string('X_input_dir', '../Data/Data_processed/A/test',
                       'X input directory, default: ../Data_classified/A/1')
tf.flags.DEFINE_string('Y_input_dir', '../Data/Data_processed/B/test',
                       'Y input directory, default: ../Data/Data_classified/B/1')

tf.flags.DEFINE_string('X_output_file', './tfrecords/A.tfrecords',
                       'X output tfrecords file, default: ./tfrecords/A.tfrecords')
tf.flags.DEFINE_string('Y_output_file', './tfrecords/B.tfrecords',
                       'Y output tfrecords file, default: ./tfrecords/B.tfrecords')
